// Gihub/Karabey Free DDos Script Source
...
void *flood(void *par1)
{
  ...
  if(s < 0){
    fprintf(stderr, "Github/Karabey Aitdir\n");
    exit(-1);
  }
...
{
  if(argc < 6){
  	printf(KRED "Github/Karabey DOWN, 17/12/2020'\n" RESET);
    fprintf(stdout, "./Gokdelen <IP> <PORT> <999> <999> <99> <Zaman>\n", argv[0]);
  ...
  fprintf(stdout, "Gokdelen Script V0.1 KARABEY Fakiyla : ");
  if(argc > 6)
  {
    sleep(atoi(argv[6]));
  } else {
